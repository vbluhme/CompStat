...
for(i in 1:5){
  lambda_opt[2*i] <- myLoocv(x[1:200*i], y[1:200*i], p, c(1, 200))$lambda
  lambda_opt[2*i-1] <- smooth.spline(x[1:200*i], y[1:200*i], cv = TRUE, nknots = p)$lambda
}
myBench <- microbenchmark( 
  "R's  implementation, n = 200" = smooth.spline(x[1:200], y[1:200], cv = TRUE, nknots = p - 2, lambda = lambda_opt[1]),
  "R's  implementation, n = 400" = smooth.spline(x[1:400], y[1:400], cv = TRUE, nknots = p - 2, lambda = lambda_opt[3]),
  "R's  implementation, n = 600" = smooth.spline(x[1:600], y[1:600], cv = TRUE, nknots = p - 2, lambda = lambda_opt[5]),
    "R's  implementation, n = 800" = smooth.spline(x[1:800], y[1:800], cv = TRUE, nknots = p - 2, lambda = lambda_opt[5]),
    "R's  implementation, n = 1000" = smooth.spline(x[1:1000], y[1:1000], cv = TRUE, nknots = p - 2, lambda = lambda_opt[5]),
  "Our implementation, n = 200" = myLoocv(x[1:200], y[1:200], p, c(1, 200), optimize = FALSE, lambda = lambda_opt[2]),
  "Our implementation, n = 400" = myLoocv(x[1:400], y[1:400], p, c(1, 200), optimize = FALSE, lambda = lambda_opt[4]),
  "Our implementation, n = 600" = myLoocv(x[1:600], y[1:600], p, c(1, 200), optimize = FALSE, lambda = lambda_opt[6]),
    "Our implementation, n = 800" = myLoocv(x[1:800], y[1:800], p, c(1, 200), optimize = FALSE, lambda = lambda_opt[4]),
  "Our implementation, n = 1000" = myLoocv(x[1:1000], y[1:1000], p, c(1, 200), optimize = FALSE, lambda = lambda_opt[6]),
  times = 50L
)
